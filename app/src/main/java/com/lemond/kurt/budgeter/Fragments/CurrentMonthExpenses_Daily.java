...
import com.lemond.kurt.budgeter.Adapters.Adapter_currentMonthExpensesDaily;
 ...
 */
public class CurrentMonthExpenses_Daily extends Fragment {
    ...
    private CardView cvTotalExpenses_budget_amount_daily;
    private FloatingActionButton mFab;
    private FloatingActionButton mFab_cancel;
    private Adapter_currentMonthExpensesDaily mAdapter;
    ...
    public CurrentMonthExpenses_Daily() {
    ...
    public static CurrentMonthExpenses_Daily newInstance(String param1, String param2) {
        CurrentMonthExpenses_Daily fragment = new CurrentMonthExpenses_Daily();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_current_month_expenses_daily, container, false);

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.lvItems_curMonthExpenses_daily);
        ...
        mTotalExpenses = (TextView) rootView.findViewById(R.id.tvTotalExpenses_curMonthExpenses_daily);
        mTotalSavingsLabel = (TextView) rootView.findViewById(R.id.tvSavings_actual_expense_label_daily);
        mTotalSavings = (TextView) rootView.findViewById(R.id.tvTotalExpenses_savings_amount_daily);
        mBudget = (TextView) rootView.findViewById(R.id.tvTotalExpenses_budget_amount_daily);

        cvTotalExpenses_budget_amount_daily = (CardView) rootView.findViewById(R.id.cvTotalExpenses_budget_amount_daily);

        mFab = (FloatingActionButton) rootView.findViewById(R.id.fab_currentMonthExpenses_daily);
        mFab_cancel = (FloatingActionButton) rootView.findViewById(R.id.fab_currentMonthExpenses_cancel_daily);

        if (savedInstanceState == null) {
            mAdapter = new Adapter_currentMonthExpensesDaily(getActivity());
            mRecyclerView.setAdapter(mAdapter);
        } else {
            mAdapter = new Adapter_currentMonthExpensesDaily(getContext(), (ArrayList<ActualExpensesClass>) savedInstanceState.getSerializable("all_items"));
            mRecyclerView.setAdapter(mAdapter);
        ...
        cvTotalExpenses_budget_amount_daily.setOnClickListener(new CustomClickListener());
    ...
    public void setTotalSavingsAndExpenses(double beforeTotalExpenses, final ActualExpensesClass actualExpense, final boolean isChecked) {
        ...
        if ((salary - beforeTotalExpenses) < 0) {
            if (mSettingsManager.getExceedExpenses().equals("Ask First")) {
                new G_AlertDialogs().setTotalSavingsAndExpenses_Dialog(getContext(), this, actualExpense, isChecked);
            } else if (mSettingsManager.getExceedExpenses().equals("Always")) {
                mAdapter.add(actualExpense, isChecked);
                updateData();
            }
        } else {
            mAdapter.add(actualExpense, isChecked);
    ...
    public void updateData() {
        ...
        mTotalExpenses.setText(mSettingsManager.getCurrency() + " " + G_Functions.formatNumber(totalExpenses));
        mTotalSavings.setText(mSettingsManager.getCurrency() + " " + G_Functions.formatNumber(totalSavings));
        addToSavingsUpdateDates();
    }

    public void addToSavingsUpdateDates() {
        //todo implement this at monthly using yyyy-mm Format on yearmonth
        HashSet<String> savingsUpdateDates = mSettingsManager.getSavingsUpdateDates();
        savingsUpdateDates.add(mSettingsManager.getCurrentDate());
        mSettingsManager.setSavingsUpdateDates(savingsUpdateDates);
    }

    public Adapter_currentMonthExpensesDaily getAdapter() {
        return mAdapter;
    }
    ...
    private class CustomClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.fab_currentMonthExpenses_daily:
                    new G_AlertDialogs().prepareAddDialog_Dialog(getContext(), mTotalExpenses, CurrentMonthExpenses_Daily.this);
                    break;
                case R.id.fab_currentMonthExpenses_cancel_daily:
                    nr = 0;
                    mActionMode.finish();
                    break;
                case R.id.cvTotalExpenses_budget_amount_daily:
                    if (!mSettingsManager.isDistributeMonthlySavings()) {
                        G_AlertDialogs.PrepareUpdateSalaryDialog_Dialog_Daily prepareUpdateSalaryDialog_dialog_daily = new G_AlertDialogs().new PrepareUpdateSalaryDialog_Dialog_Daily(getContext(), CurrentMonthExpenses_Daily.this);
                        prepareUpdateSalaryDialog_dialog_daily.execute();
                    }
                    break;
                default:
            }
                ...
                public boolean onSingleTapConfirmed(MotionEvent e) {
                    ...
                    if (itemSelected > -1) {
                        if (mAdapter.isItemLongClicked()) {
                            ...
                            new G_AlertDialogs().CustomOnItemClick_Dialog(getContext(), mAdapter.getItem(itemSelected), CurrentMonthExpenses_Daily.this);
                        }
                    }
                    return false;
                }
